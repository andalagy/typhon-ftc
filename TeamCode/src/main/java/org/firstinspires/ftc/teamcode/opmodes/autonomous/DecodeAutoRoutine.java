...
public class DecodeAutoRoutine {
    ...
    public DecodeAutoRoutine(LinearOpMode opMode, Alliance alliance, StartPos startPos) {
        this.opMode = opMode;
    ...
    public void initLoop() {
        ...
        opMode.telemetry.addLine("Use gamepad1.x for BLUE, gamepad1.b for RED");
        ...
        switch (state) {
            ...
            case ALIGN_APPROACH:
                if (hasTarget) {
                    ...
                    drive.drive(applyAllianceSign(strafe), forward, turn, false);
    ...
    private double applyAllianceSign(double value) {
        return alliance == Alliance.BLUE ? value : -value;
    }
    ...
    private DriveCommand getIntakeDrive() {
        ...
        return new DriveCommand(applyAllianceSign(strafe), forward);
    }
